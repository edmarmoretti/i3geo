...
class Arvore
{
	...
	*/
	...
	{
		$s = ereg_replace("[&aacute;â&acirc;&atilde;]","a",$s);
		$s = ereg_replace("[&Aacute;Â&Acirc;&Atilde;]","A",$s);
		$s = ereg_replace("[&eacute;á&ecirc;]","e",$s);
		$s = ereg_replace("[&iacute;]","i",$s);
		$s = ereg_replace("[&Iacute;]","I",$s);
		$s = ereg_replace("[&Eacute;É&Ecirc;]","E",$s);
		$s = ereg_replace("[ôõ&ocirc;&otilde;]","o",$s);
		$s = ereg_replace("[ÔÕ&Ocirc;&Otilde;]","O",$s);
		$s = ereg_replace("[&uacute;ú]","u",$s);
		$s = ereg_replace("[&Uacute;Ú]","U",$s);

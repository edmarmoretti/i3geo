...
function iniciaMapa()
{
	...
	if ($embedLegenda == "sim")
	{
		...
		{
			if (($l->data != "") && ($l->getmetadata("escondido") != "SIM") && ($l->getmetadata("tema") != "NAO"))
			{
				if ($l->numclasses > 0)
				{
					$classe = $l->getclass(0);
	...
	{
		if (($oLayer->getmetadata("tema") != "NAO") && ($oLayer->getmetadata("ESCONDIDO") == ""))
		{
			$sel = "nao";
	...
	$res .= ";var refimagem='';var refwidth=0;var refheight=0;var refpath='';var refurl=''";

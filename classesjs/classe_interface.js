...
i3GEO.Interface = {
	...
	retorno {JSON} - objeto JSON com os par�metros obtidos da fun&ccedil;&atilde;o PHP de redesenho do mapa. Quando igual a "", &eacute; feita apenas a atualiza&ccedil;&atilde;o da camada, sem que a &aacute;rvore de camadas seja atualizada.
	...
	Para detalhes sobre a configura&ccedil;&atilde;o da interface, veja i3geo/aplicmap/openlayers.htm
		...
		Nome do layer do tipo baselayer que sera ativado
			...
			criaLayers: function(){
				...
				if(i3GEO.Interface.openlayers.googleLike === true){
					url = configura.locaplic+"/classesphp/mapa_googlemaps.php?g_sid="+i3GEO.configura.sid+"&TIPOIMAGEM="+configura.tipoimagem;
				}
				//
	...
	Cria tamb&eacute;m o objeto i3GeoMapOverlay do tipo Overlay, utilizado para c&aacute;lculos ou para receber elementos gr&aacute;ficos.
		...
		{array}
			...
			/*
		Par�metros adicionais que s&atilde;o inseridos na URL que define cada layer
		...
		{string}
			...
			/*
		String acrescentada � url de cada tile para garantir a remo&ccedil;&atilde;o do cache local

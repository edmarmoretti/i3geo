	...
	*/
	oMenuData:{
		...
		submenus:{
			...
			{ id:"omenudataArquivos6",text: $trad("x72"), url: "javascript:i3GEO.mapa.dialogo.listaDeMapasBanco()" },
			...
			{ id:"omenudataFerramentas5a",text: "<span class='i3GEOconeFerramenta i3GEOiconeBusca'></span>" + $trad("x59"), url: "javascript:i3GEO.mapa.dialogo.locregiao()"},
			{ id:"omenudataFerramentas6a",text: "<span class='i3GEOconeFerramenta i3GEOiconeFiltro'></span>" + $trad("x61"), url: "javascript:i3GEO.mapa.dialogo.filtraregiao()"},
			{ id:"omenudataFerramentas4a",text: "<span class='i3GEOconeFerramenta i3GEOiconeCatalogo'></span>" + $trad("g1a"), url: "javascript:i3GEO.arvoreDeTemas.flutuante()"},
			...
			{ id:"omenudataFerramentas2a",text: "<span class='i3GEOconeFerramenta i3GEOiconeAnimacao'></span>" + $trad("p21"), url: "javascript:i3GEO.mapa.dialogo.animacao()"},
			{ id:"omenudataFerramentas3a",text: "<span class='i3GEOconeFerramenta i3GEOiconeSelecao'></span>" + $trad("d24t"), url: "javascript:i3GEO.mapa.dialogo.selecao();"},
			{ id:"omenudataFerramentas7a",text: "<span class='i3GEOconeFerramenta i3GEOiconeCongela'></span>" + $trad("x64a"), url: "javascript:i3GEO.mapa.dialogo.congelaMapa();"},
			...
			{ id:"omenudataFerramentas12",text: "<span class='i3GEOconeFerramenta i3GEOiconeCliqueTexto'></span>" + $trad("d25t"), url: "javascript:i3GEO.mapa.dialogo.cliqueTexto()"},
			//temas
			{ id:"omenudataFerramentas0b",text: '<span style=color:gray;text-decoration:underline; ><b>'+$trad("a7")+'</b></span>',url: "#"},
			{ id:"omenudataFerramentas1b",text: "<span class='i3GEOconeFerramenta i3GEOiconeTabela'></span>" + $trad("t31"), url: "javascript:i3GEO.tema.dialogo.tabela()"},
			{ id:"omenudataFerramentas2b",text: "<span class='i3GEOconeFerramenta i3GEOiconeBusca'></span>" + $trad("t23"), url: "javascript:i3GEO.tema.dialogo.procuraratrib()"},
			{ id:"omenudataFerramentas3b",text: "<span class='i3GEOconeFerramenta i3GEOiconeToponimia'></span>" + $trad("t25"), url: "javascript:i3GEO.tema.dialogo.toponimia()"},
			{ id:"omenudataFerramentas4b",text: "<span class='i3GEOconeFerramenta i3GEOiconeEtiqueta'></span>" + $trad("t27"), url: "javascript:i3GEO.tema.dialogo.etiquetas()"},
			{ id:"omenudataFerramentas5b",text: "<span class='i3GEOconeFerramenta i3GEOiconeFiltro'></span>" + $trad("t29"), url: "javascript:i3GEO.tema.dialogo.filtro()"},
			{ id:"omenudataFerramentas6b",text: "<span class='i3GEOconeFerramenta i3GEOiconeLegenda'></span>" + $trad("t33"), url: "javascript:i3GEO.tema.dialogo.editaLegenda()"},
			{ id:"omenudataFerramentas7b",text: "<span class='i3GEOconeFerramenta i3GEOiconeCortina'></span>" + $trad("t42"), url: "javascript:i3GEO.tema.dialogo.cortina()"},
			{ id:"omenudataFerramentas8b",text: "<span class='i3GEOconeFerramenta i3GEOiconeGrTema'></span>" + $trad("t37a"), url: "javascript:i3GEO.tema.dialogo.graficotema()"},
			{ id:"omenudataFerramentas9b",text: "<span class='i3GEOconeFerramenta i3GEOiconeGrafico'></span>" + $trad("t37b"), url: "javascript:i3GEO.analise.dialogo.graficoInterativo1()" },
			//cartogramas
			{ id:"omenudataFerramentas0e",text: '<span style=color:gray;text-decoration:underline; ><b>'+$trad("x60")+'</b></span>',url: "#"},
			{ id:"omenudataFerramentas1e",text: "<span class='i3GEOconeFerramenta i3GEOiconeCartograma'></span>" + $trad("x57"), url: "javascript:i3GEO.mapa.dialogo.metaestat()"},
			{ id:"omenudataFerramentas4e",text: "<span class='i3GEOconeFerramenta i3GEOiconeAplicStat'></span>" + $trad("x71"), url: "javascript:i3GEO.mapa.dialogo.metaestatListaMapas()"},

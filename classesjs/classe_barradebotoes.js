...
i3GEO.barraDeBotoes =
{
	 ...
	 * Parametro:
	 *
	 * {String} - botao que ser&aacute; mostrado como ativo (opcional). Se n&atilde;o for definido, ser&aacute; utilizado o
	 * bot&atilde;o especificado em BOTAOPADRAO. O nome do botao deve estar em LISTABOTOES na propriedade iddiv
	 */
	...
	inicializaBarraOP : function(onde) {
		...
		dock.setBar({
			left : {
				euImage : {
					image : i3GEO.configura.locaplic + "/pacotes/eudock/barImages/" + tempAjuda
				}
			},
			horizontal : {
				euImage : {
					image : i3GEO.configura.locaplic + "/pacotes/eudock/barImages/dockBg-c-o.png"
				}
			},
			right : {
				euImage : {
					image : i3GEO.configura.locaplic + "/pacotes/eudock/barImages/" + temp
				}
			}
		});
	...
	inicializaBarra : function(idconteudo, idconteudonovo, barraZoom, x, y, onde) {
		...
		if (i3GEO.barraDeBotoes.TIPO === "olhodepeixe" || i3GEO.barraDeBotoes.TIPO === "olhodepeixe1") {
			...
			if (this.TEMPLATEBOTAO === "" && i3GEO.Interface.TABLET === false) {
				this.TEMPLATEBOTAO =
					"<div style='display:inline;background-color:rgb(250,250,250);'><img style='border:0px solid white;' src='"
					+ i3GEO.configura.locaplic + "/imagens/branco.gif' id='$$'/></div>";
			}
			if (this.TEMPLATEBOTAO === "" && i3GEO.Interface.TABLET === true) {
				this.TEMPLATEBOTAO =
					"<div style='display:inline;background-color:rgb(250,250,250);'><img style='margin:4px;border:0px solid white;' src='"
					+ i3GEO.configura.locaplic + "/imagens/branco.gif' id='$$'/></div>";
			}
			...
			if (this.AUTO === true) {
				if (idconteudo === "barraDeBotoes1") {
					...
					temp =
						'<table style="width:100%"><tr><td style="background-color:rgb(250,250,250);"><div ID="historicozoom" ></div></td></tr><tr><td style=height:5px ></td></tr></table>'
						...
						+ "</div>"
						+ "<div style='display:inline;background-color:rgb(250,250,250);'>"
						+ '<img title="geral" alt="geral" src="' + branco + '" id="zoomtot"/>' + "</div>";
					novoel.innerHTML = temp;
	 ...
	 * Parametro:
	 *
	 * {Integer} - &iacute;ndice do array BARRAS que guarda os objetos YAHOO com as barras Se n&atilde;o for definido, todas as
	 * barras ser&atilde;o reativadas
	 */
	...
	mostraJanela : function(objeto, mensagem, evt) {
		...
		var divmensagem = $i("divMensagemBarraDeBotoes"), balloonAjuda, pos = YAHOO.util.Dom.getXY(objeto);
		...
		if (!divmensagem && this.TIPOAJUDA !== "balao") {
			...
			if (this.TIPOAJUDA === "horizontal") {
				divmensagem.innerHTML =
					"<table style='z-index:20000' ><tr><td id='imgMensagemBarraDeBotoes' style='background:none;padding-top:2px;padding-right:3px;vertical-align:top'><img src='"
					+ i3GEO.configura.locaplic + "/imagens/left.png"
			...
			if (this.TIPOAJUDA === "vertical") {
				divmensagem.innerHTML =
					"<table style='z-index:20000' ><tr><td id='imgMensagemBarraDeBotoes' style='background:none;padding-top:2px;padding-right:3px;vertical-align:top'><img src='"
					+ i3GEO.configura.locaplic + "/imagens/top.png"
					+ "' ></td><td style='text-align:left;border-left:1px solid rgb(210,210,210)'><span style='text-align:right;cursor:pointer;color:blue;' onclick='javascript:i3GEO.util.insereCookie(\"botoesAjuda\",\"nao\");i3GEO.barraDeBotoes.AJUDA = false;'>fecha</span><br><div style='vertical-align:middle;text-align:left;width:250px;border: 0px solid black;border-left:1px;' id='divMensagemBarraDeBotoesCorpo'></div></td></tr></table>";
			}
		}
		if (mensagem !== "") {
			if (this.TIPOAJUDA !== "balao") {
				...
				mensagem =
					"<table style='z-index:20000' ><tr><td style='text-align:left;'><span style='text-align:right;cursor:pointer;color:blue;' onclick='javascript:i3GEO.util.insereCookie(\"botoesAjuda\",\"nao\");i3GEO.barraDeBotoes.AJUDA = false;'>fecha</span><br><div style='vertical-align:middle;text-align:left;width:250px;border: 0px solid black;border-left:1px;' id='divMensagemBarraDeBotoesCorpo'>"
					+ mensagem + "</div></td></tr></table>";
				try {
					clearTimeout(i3GEO.barraDeBotoes.timeAjudaBotoes);
				} catch (e) {
				}
				i3GEO.barraDeBotoes.timeMostraAjudaBotoes = setTimeout(function() {
					...
					try {
						clearTimeout(timeMostraAjudaBotoes);
					} catch (e) {
					}

...
i3GEO.guias = {
	 ...
	 *
	 * Por default, a altura &eacute; calculada automaticamente, mas em alguns
	 * casos, pode ser necess&aacute;rio especificar o valor para permitir um
	 ...
	 *
	 * Define os par&acirc;metros de cada guia que ser&aacute; mostrada no mapa,
	 * como t&iacute;tulo, conte&uacute;do, etc.
	 *
	 * Voc&ecirc; pode modificar o nome de uma guia como no exemplo
	 *
	 * i3GEO.guias.CONFIGURA.legenda.titulo = "nome diferente";
	 *
	 * Por padr&atilde;o s&atilde;o definidas as guias legenda, temas, adiciona
	 * e mapas (links)
	 *
	 * Exemplo
	 *
	 * i3GEO.guias.CONFIGURA.legenda = { titulo:"Legenda do mapa", id:"guia4",
	 * idconteudo:"guia4obj",//id do elemento HTML que cont&eacute;m o
	 * conte&uacute;do da guia click: function(){
	 ...
	 * na vari&aacute;vel configura.<b> As guias, nesse caso, devem ter como ID
	 * "guia'n'", por exemplo id="guia6". Para cada uma dessas guias deve haver
	 * um DIV com o conte&uacute;do. Esse DIV deve ter como ID "guia'n'obj", por
	 * exemplo id="guia6obj". No caso de ser utilizado a guia m&oacute;vel, com
	 * i3GEO.guias.TIPO = "movel" , "guia'n" n&atilde;o &eacute;
	 * necess&aacute;rio, uma vez que s&atilde;o utilizados os &iacute;cones
	...
	mostra : function(guia) {
		...
		//
		// verifica se o nome da guia passado como parametro est&aacute; correto
	 ...
	 * Parametros:
	 *
	 * guia {String} - O elemento html cujo id for igual a guia+"obj"
	 * ter&aacute; seu estilo (display) definido como block, tornando-o
	 * vis&iacute;vel
	 *
	 * namespace {String} - Todos os elementos html que tiverem como id o
	 * namespace, seguindo por um n&uacute;mero e "obj", ter&atilde;o seu estilo
	 * alterado para none, tornando-se invis&iacute;veis
	 *
	 */
	...
	guiaMovel : {
		...
		ABERTA : false,
		/*
		 * Define os valores de posicionamento dos elementos que comp&otilde;em
		 * a guia
		 */
		config : {
			larguraPuxador : 50,

...
function Mapa(e,m)
{
	...
	*/
	...
	{
		YAHOO.log("Verificando movimento domouse no mapa", "i3geo");
		...
		YAHOO.log("Fim verificando movimento domouse no mapa", "i3geo");
	};
	/*
	...
	*/
	...
	{
		YAHOO.log("Verificando mouse parado", "i3geo");
		try
		{
		...
		YAHOO.log("Fim verificando mouse parado", "i3geo");
	};
	/*

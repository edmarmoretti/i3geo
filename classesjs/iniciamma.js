	...
	this.montaMapa = function (retorno)
	{
		...
		else
		{
			if ((retorno.data != "erro") && (retorno.data != undefined))
			{
               ...
               if ($i("menus"))
               {YAHOO.example.onWindowLoadMenu();}
				...
				if ($i("maisBotoes1")){YAHOO.janelaBotoes1.xp.panel.moveTo(imagemxi+40,imagemyi+10);}
	...
	this.atualizaListaTemas = function(temas)
	{
		if (($i("listaTemas")) && (objmapa.temas != temas))
		{
			...
			for (l=0;l<lista.length; l++)
			{
				...
				if (cor == "rgb(250,250,250)"){var cor = "rgb(255,255,255)";}
				else
				{var cor = "rgb(250,250,250)";}
			}
		}

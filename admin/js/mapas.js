...
i3GEOadmin.mapas = {
	...
	formulario: function(i){
		...
		//ins += "<p>Mapfile (c�digo do mapfile que ser&aacute; utilizado para criar a camada no i3geo):"
		...
		ins += "<p>Temas que ser&atilde;o inclu&iacute;dos nesse mapa (utilize os c�digos dos mapfiles mostrados na lista abaixo): </p>";

...
<div class="container-fluid migalha">
	<div class="row">
		<div class="btn-group btn-breadcrumb">
			...
			<a class="btn btn-default" href="../index.php?id_n1=<?php echo $id_n1; ?>"><span>Subgrupos</span></a>
			<a class="btn btn-default" style="pointer-events: none"><span>Lista de sub grupos</span></a>
		</div>
	</div>
</div>

...
switch ($funcao) {
    case "ALTERAR":
        ...
        $dados = \admin\catalogo\mapfile\comportamento\alterar($_SESSION["locaplic"], $id_tema, $codigo, $_POST["aplicaextensao"], $_POST["temporizador"], $_POST["escondido"], $_POST["transitioneffect"], $_POST["status"], $_POST["iconetema"], $_POST["mensagem"], $_POST["wkttip"]);
        if ($dados === false) {

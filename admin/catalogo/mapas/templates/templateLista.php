...
<div class="list-group-item" id="form-{{id_mapa}}">
	<div class="row-content">
		<h4 class="list-group-item-heading {{escondido}}">
			<a title="{{{editarI3geo}}}" href="javascript:void(0)" onclick="window.open('../../../admin/black_editorCriaMapa.php?id_mapa={{id_mapa}}')" class="contemmapfile{{contemmapfile}} btn btn-danger btn-fab btn-fab-mini pull-right" role="button">
				<i class="material-icons md-18">map</i>
			</a>
            <span class="pull-right">&nbsp;&nbsp;</span>
			<a title="{{{testarI3geo}}}" href="javascript:void(0)" onclick="window.open('../../../mapas/link.php?id={{id_mapa}}')" class="btn btn-danger btn-fab btn-fab-mini pull-right" role="button">

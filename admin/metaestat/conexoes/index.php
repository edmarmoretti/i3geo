...
<div class="container-fluid migalha">
	<div class="row">
		<div class="btn-group btn-breadcrumb">
			...
			<a class="btn btn-default" style="pointer-events: none"><span>Conex&otilde;es</span></a>
		</div>
	</div>
</div>
<div class="container">
			...
			<div class="well hidden">
				<div class="panel-heading">
					<p class="lead" style="margin:0px;">&nbsp;
						<a title="{{{adicionar}}}" onclick="i3GEOadmin.conexoes.adicionaDialogo();" href="javascript:void(0)"
...
<script type="text/javascript" src="../../dicionario/estat_conexao.js"></script>
<script>
	$(document).ready(function(){
		...
		i3GEOadmin.conexoes.dicionario = $.extend(
			{},
		...
		i3GEOadmin.conexoes.dicionario = i3GEO.idioma.objetoIdioma(i3GEOadmin.conexoes.dicionario);
		...
		$.material.init();
			...
			i3GEOadmin.conexoes.init($("#corpo"));
	});
</script>
</body>
</html>

...
<div class="container-fluid migalha">
	<div class="row">
		<div class="btn-group btn-breadcrumb">
			...
			<a class="btn btn-default" style="pointer-events: none"><span>Vari&aacute;veis</span></a>
		</div>
	</div>
</div>
<div class="container">
			...
			<div class="well hidden">
				<div class="panel-heading">
					<p class="lead" style="margin:0px;">&nbsp;
						<a title="{{{adicionar}}}" onclick="i3GEOadmin.variaveis.adicionaDialogo();" href="javascript:void(0)"
...
<script>
	$(document).ready(function(){
		...
		i3GEOadmin.variaveis.dicionario = $.extend(
			{},
		...
		i3GEOadmin.variaveis.dicionario = i3GEO.idioma.objetoIdioma(i3GEOadmin.variaveis.dicionario);
		...
		$.material.init();
			...
			i3GEOadmin.variaveis.init($("#corpo"));
	});
</script>
</body>
</html>

			...
			<div class="well hidden">
				<div class="panel-heading">
					<p class="lead" style="margin: 0px;">
						&nbsp;
						<a title="{{{adicionar}}}" onclick="i3GEOadmin.linksmedida.adicionaDialogo();" href="javascript:void(0)" class="pull-right btn btn-danger btn-fab btn-fab-mini" role="button">
...
<script>
	$(document).ready(function(){
		...
		i3GEOadmin.linksmedida.dicionario = $.extend(
			{},
		...
		i3GEOadmin.linksmedida.dicionario = i3GEO.idioma.objetoIdioma(i3GEOadmin.linksmedida.dicionario);
		...
		i3GEOadmin.linksmedida.id_medida_variavel = <?php echo $id_medida_variavel; ?>;
		i3GEOadmin.linksmedida.codigo_variavel = <?php echo $codigo_variavel; ?>;
		$.material.init();
		i3GEOadmin.core.loginOn();
		$(".hidden").removeClass('hidden');
		i3GEOadmin.linksmedida.init($("#corpo"));
	});
</script>
</body>
</html>

...
<div class="container-fluid migalha">
	<div class="row">
		<div class="btn-group btn-breadcrumb">
			...
			<a class="btn btn-default" style="pointer-events: none"><span>Fontes de dados</span></a>
		</div>
	</div>
</div>
<div class="container">
			...
			<div class="well hidden">
				<div class="panel-heading">
					<p class="lead" style="margin:0px;">&nbsp;
						<a title="{{{adicionar}}}" onclick="i3GEOadmin.fontes.adicionaDialogo();" href="javascript:void(0)"
...
<script type="text/javascript" src="../../dicionario/estat_fontes.js"></script>
<script>
	$(document).ready(function(){
		...
		i3GEOadmin.fontes.dicionario = $.extend(
			{},
		...
		i3GEOadmin.fontes.dicionario = i3GEO.idioma.objetoIdioma(i3GEOadmin.fontes.dicionario);

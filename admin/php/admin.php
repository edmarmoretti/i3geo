<?php
/*
Title: FunÁıes de uso geral

FunÁıes utilizadas por outros programas do sistema de administraÁ„o.

No inÌ≠cio do programa È feita a inclus„o do i3geo/ms_configura.php e i3geo/classesphp/funcoes_gerais.php
...
Direitos Autorais Reservados (c) 2006 MinistÈrio do Meio Ambiente Brasil
Desenvolvedor: Edmar Moretti edmar.moretti@mma.gov.br

Este programa È software livre; vocÍ pode redistribuÌ-lo
e/ou modific·-lo sob os termos da LicenÁa P˙blica Geral
GNU conforme publicada pela Free Software Foundation;

Este programa È distribuÌdo na expectativa de que seja ˙til,
porÈm, SEM NENHUMA GARANTIA; nem mesmo a garantia implÌcita
de COMERCIABILIDADE OU ADEQUA«√O A UMA FINALIDADE ESPECÕFICA.
Consulte a LicenÁa P˙blica Geral do GNU para mais detalhes.
VocÍ deve ter recebido uma cÛpia da LicenÁa P˙blica Geral do
GNU junto com este programa; se n„o, escreva para a
Free Software Foundation, Inc., no endereÁo
...
Imprime na sa√≠da a string JSON
*/
...
dbh {PDO} - objeto PDO de conex√£o com o banco
...
Exlcui um registro de uma tabela do banco de dados de administra√ß√£o

Utiliza vari√°veis globais para fazer a consulta ao banco
...
locaplic {string} - endere√ßo do i3Geo no sistema de arquivos
...
Verifica se o pai tem filhos nos componentes hier√°rquicos do banco de administra√ß√£o

Por exemplo, pode-se verificar se um grupo possu√≠ subgrupos, indicando-se como tabela i3geoadmin_grupos e o id do grupo
...
Converte uma string para uma codifica√ß√£o de caracteres determinada
...
Mostra formul·rio para login quando È necess·rio o uso da vari·vel $i3geomaster cadastrada em ms_configura.php

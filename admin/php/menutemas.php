...
Funчѕes utilizadas nas operaчѕes de manutenчуo de menus, grupo, subgrupos e temas

Щ utilizado nas funчѕes em AJAX da interface de ediчуo da сrvore de menus para ediчуo de cada um de seus componentes

Essas funчѕes complementam <arvore.php>
...
Direitos Autorais Reservados (c) 2006 Ministщrio do Meio Ambiente Brasil
Desenvolvedor: Edmar Moretti edmar.moretti@mma.gov.br

Este programa щ software livre; vocъ pode redistribuэ-lo
e/ou modificс-lo sob os termos da Licenчa Pњblica Geral
GNU conforme publicada pela Free Software Foundation;
tanto a versуo 2 da Licenчa.
Este programa щ distribuэdo na expectativa de que seja њtil,
porщm, SEM NENHUMA GARANTIA; nem mesmo a garantia implэcita
de COMERCIABILIDADE OU ADEQUAЧУO A UMA FINALIDADE ESPECЭFICA.
Consulte a Licenчa Pњblica Geral do GNU para mais detalhes.
Vocъ deve ter recebido uma cѓpia da Licenчa Pњblica Geral do
GNU junto com este programa; se nуo, escreva para a
Free Software Foundation, Inc., no endereчo
...
O parтmetro principal щ "funcao", que define qual operaчуo serс executada, por exemplo, menutemas.php?funcao=pegaMenus

Cada operaчуo possuэ seus prѓprios parтmetros, que devem ser enviados tambщm na requisiчуo da operaчуo.
...
if($idioma == "")
{$idioma = "pt";}
//faz a busca da funчуo que deve ser executada
switch (strtoupper($funcao))
{
	/*
	Note:
	
	Valores que o parтmetro &funcao pode receber. Os parтmetros devem ser enviados na requisiчуo em AJAX.
	*/
	...
	*/	
	case "PEGATEMAPORMAPFILE":
		...
		{$dados = "erro. Mais de um mapfile com mesmo cѓdigo registrado no banco";}
		retornaJSON($dados);
		exit;
	break;	
	/*
	...
	*/	
	case "ALTERATEMAS":
		//$r serс igual ao novo id criado, no caso de inserчуo de um novo tema
		if(verificaEditores($editores) == "nao")
		{echo "Vc nao e um editor cadastrado. Apenas os editores definidos em i3geo/ms_configura.php podem acessar o sistema de administracao.";exit;}
		$r = alteraTemas();
		if($id == "")
...
function alteraTemas()
{
	...
	try 
	{
    	...
    	//verifica se щ necessсrio adicionar algum tag novo
    	$tags = explode(" ",$tags);

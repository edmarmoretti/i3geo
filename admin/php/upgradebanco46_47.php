...
$teste = lista("select * from ".$esquemaadmin."i3geoadmin_usuarios","id_usuario");
if(!in_array($teste,1))
	$dbhw->query("INSERT INTO ".$esquemaadmin."i3geoadmin_usuarios VALUES(1,'','',1,'admin','admin','admin')");

$teste = lista("select * from ".$esquemaadmin."i3geoadmin_papelusuario","id_usuario","id_papel");
if(!in_array($teste,"1-1"))
	$dbhw->query("INSERT INTO ".$esquemaadmin."i3geoadmin_papelusuario VALUES(1,1)");

$teste = lista("select * from ".$esquemaadmin."i3geoadmin_operacoes","id_operacao");
if(!in_array($teste,1))
...
if(!in_array($teste,16))
	$dbhw->query("INSERT INTO ".$esquemaadmin."i3geoadmin_operacoes VALUES(16,'admin/php/editortexto','editor de texto para mapfiles')");

$teste = lista("select * from ".$esquemaadmin."i3geoadmin_operacoes","id_operacao","id_papel");

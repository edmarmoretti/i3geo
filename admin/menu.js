...
function iniciaMenuPrincipal() {
	...
	$(menuPrincipal).each(
		function (i, el) {
			l.push('<li class="dropdown" ><a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" >' + el.html + '<span class="caret"></span></a>');
			if (el.children) {
				...
				$(el.children).each(
					function (i, el) {
						...
						if (el.children) {
							l.push('<li class="dropdown dropdown-submenu" ><a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">' + el.html + '</a>');

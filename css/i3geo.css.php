<?php if(extension_loaded('zlib')){ob_start('ob_gzhandler');} header("Content-type: text/css"); ?>caption
...
.verdeclaro
{padding: 0px;background-color:#d5e9c1;margin:0px;border: 0px solid #d5e9c1;font-family: Verdana, Arial, Helvetica, sans-serif;z-index:1000;}
.verdemedio
...
.yui-resizepanel .resizehandle { 
     ...
     padding: 0; 
     z-index: 3000; 
     background: url(../pacotes/yui231/build/container/img/corner_resize.gif) left bottom no-repeat;
     cursor: se-resize;
 }

#buscafotos,#area,#confluence,#scielo,#wiki,#inseregrafico,#realca,#reinicia,#google,#zoomtot,#pan,#zoomli,#zoomlo,#zoomiauto,#zoomoauto,#identifica,#lentei,#reinicia,#exten,#selecao,#inserexy,#textofid,#mede,#perfil,#cruza,#tamanho,#imprimir,#salva,#carrega,#referencia,#pegaimagens,#v3d
...
#zoomoauto
{background-image:URL('../imagens/out.png');}
#zoomiauto
...
.yui-skin-sam .yui-panel-container{z-index:2000;padding:0 1px;*padding:2px 3px;}
.yui-skin-sam .yui-panel{position:relative;*zoom:1;left:0;top:0;border-style:solid;border-width:1px 0;border-color:#808080;z-index:2000;}
...
padding:0 10px;font-size:70%;line-height:2;*line-height:1.9;font-weight:bold;color:#000;
background:url(../pacotes/yui231/build/assets/skins/sam/sprite.png) repeat-x 0 -200px;}
.yui-skin-sam .yui-panel .bd{padding:0px;}
.yui-skin-sam .yui-panel .ft{border-top:solid 1px #808080;padding:5px 10px;font-size:0%;}
.yui-skin-sam .yui-panel-container.focused .yui-panel .hd{}
.yui-skin-sam .container-close{z-index:2001;position:absolute;top:1px;right:1px;width:14px;height:15px;background:url(../pacotes/yui231/build/assets/skins/sam/sprite.png) no-repeat 0 -300px;cursor:pointer;}
...
.yui-skin-sam .yui-panel-container.shadow .underlay{z-index:0;position:absolute;top:2px;right:-3px;bottom:-3px;left:-3px;*top:3px;*left:-1px;*right:-1px;*bottom:-1px;_top:0;_right:0;_bottom:0;_left:0;_margin-top:3px;_margin-left:-1px;background-color:#000;opacity:.12;*filter:alpha(opacity=12);}
...
{background-color: buttonface; color: black; text-decoration: none; cursor: default; padding: 1px; border: 1px dotted threedshadow;}
.TreeviewItemTextOut
{cursor:pointer;}

...
.digitar
{border: 0px solid gray;border-bottom:1px solid gray;font-size: 10px;font-family: Verdana, Arial, Helvetica, sans-serif;}
.legendaTema
...
#vertMaisZoom {cursor:pointer;position:relative;top:2px; width:18px; background:url(../imagens/zoom-plus-mini.png) no-repeat;height:18px; }
#vertMenosZoom {cursor:pointer;position:relative;top:-1px; width:18px; background:url(../imagens/zoom-minus-mini.png) no-repeat;height:18px; }
...
#area,#confluence,#scielo,#wiki,#inseregrafico,#realca,#reinicia,#google,#zoomtot,#pan,#zoomli,#zoomlo,#zoomiauto,#zoomoauto,#identifica,#lentei,#reinicia,#exten,#selecao,#inserexy,#textofid,#mede,#perfil,#cruza,#tamanho,#imprimir,#salva,#carrega,#referencia,#pegaimagens,#v3d
...
#aplicari#funcoesrapidasi
{display:none;position:absolute;cursor:pointer;z-index:1000;}
...
#zoomli
{background-image:URL('../imagens/zoomli.png');}
#zoomtot
{
	background-image:URL('../imagens/sprite.png');
	background-repeat: no-repeat;
...
.yui-skin-sam .yui-panel .hd{padding:0 10px;font-size:70%;line-height:2;*line-height:1.9;font-weight:bold;color:#000;background:url(../../../../assets/skins/sam/sprite.png) repeat-x 0 -200px;}
.yui-skin-sam .yui-panel .bd{padding:0px;}
.yui-skin-sam .yui-panel .ft{border-top:solid 1px #808080;padding:5px 10px;font-size:0%;}
.yui-skin-sam .yui-panel-container.focused .yui-panel .hd{}
.yui-skin-sam .container-close{z-index:2001;position:absolute;top:1px;right:1px;width:14px;height:15px;background:url(../../../../assets/skins/sam/sprite.png) no-repeat 0 -300px;cursor:pointer;}

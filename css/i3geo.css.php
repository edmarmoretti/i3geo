<?php if(extension_loaded('zlib')){ob_start('ob_gzhandler');} header("Content-type: text/css"); ?>.paragrafo
{font-size:12px;line-height:15px;margin-bottom:9px;text-align:left;}
.lista td
{border: 0px solid rgb(240,240,240);border-left: 0px;border-right:0px;border-top:0px;padding: 0px;color:#2F4632;margin:0px;text-align:left;font-size: 10px;font-family: Verdana, Arial, Helvetica, sans-serif;}
.lista2 td
...
background:transparent url(../pacotes/yui270/build/assets/skins/sam/sprite.png) repeat-x scroll 0 0px;
color:#000000;
font-size:70%;
font-weight:bold;
line-height:2;
...
.yui-skin-sam .yui-navset .yui-nav a:hover{
    background:#bfdaff url(../pacotes/yui270/build/assets/skins/sam/sprite.png) repeat-x left -1300px; /* selected tab background */
    outline:0;
}
...
.yui-skin-sam .yui-button{
	border-width:1px 0;border-style:solid;border-color:#808080;background:url(../pacotes/yui270/build/assets/skins/sam/sprite.png) repeat-x 0 0;margin:auto .25em;
}

.yui-skin-sam .yui-button .yui-push-button .yui-button-hover .yui-push-button-hover
{color:#bfdaff;}

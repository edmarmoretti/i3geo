...
<script src="../interface/config.php?tipo=OSM"></script>
                ...
                <div id="i3GEOguiaMovelConteudo">
                    ...
                    <div id='guia2obj' data-traduzir="true" style='display: none; text-align: left;'>
						...
						-->
                            ...
                            <div class="list-group condensed">
                                <div class="row-content text-left">
                                    <a onclick="i3GEO.catalogoWs.inicia();return false;" role="button" class="btn btn-primary btn-fab btn-fab-max" href="javascript:void(0)"><span
                                        class="material-icons ">folder_open</span></a> <label style="width: 255px; vertical-align: middle;"> <a onclick="i3GEO.catalogoWs.inicia()" role="button"

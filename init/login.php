	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<span class="material-icons md-18">home</span></a>
			</div>
			<div id="navbar" class="navbar-collapse collapse navbar-responsive-collapse">
				...
				<div id="menuTpl" class="hidden">
					<ul class="nav navbar-nav">
						<li><a data-bs-toggle="collapse"data-target=".in" role="button" href="#topo" onclick="$('.cartao').hide();$('.map-o').fadeIn(600);">{{{mapas}}}</a></li>
						<li><a data-bs-toggle="collapse"data-target=".in" role="button" href="#topo" onclick="$('.cartao').hide();$('.download').fadeIn(600);">OGC/Download</a></li>
						<li><a data-bs-toggle="collapse"data-target=".in" role="button" href="#topo" onclick="$('.cartao').hide();$('.cogs').fadeIn(600);">{{{admin}}}</a></li>
						<li><a data-bs-toggle="collapse"data-target=".in" role="button" href="#topo" onclick="$('.cartao').hide();$('.book').fadeIn(600);">{{{docs}}}</a></li>
						<li><a data-bs-toggle="collapse"data-target=".in" role="button" href="#topo" onclick="$('.cartao').hide();$('.group').fadeIn(600);">{{{comunidade}}}</a></li>
						...
						href="#" class="dropdown-toggle" data-bs-toggle="dropdown">Login <span class="caret"></span></a>
		...
		<div class="row text-center hidden">
			<div class="col-lg-12 center-block">
				...
				licenciado com uma Licen&ccedil;a <a tabindex="-1" rel="license"
					href="http://creativecommons.org/licenses/GPL/2.0/legalcode.pt" style="color:#0f4c81;" target="_blank">Creative

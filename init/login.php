					...
					<div class="panel panel-default">
						...
						<div class="panel-footer text-right"
							...
							<div class="row center-block">
								...
								<div class="col-xs-6">
									<a class="btn btn-primary" style="color:#FF6F61;" href="{{{href}}}" role="button" target="{{{target}}}">
										{{{abrir}}} </a>
								</div>
		...
		<div class="row text-center hidden">
			<div class="col-lg-12 center-block">
				...
				licenciado com uma Licen&ccedil;a <a tabindex="-1" rel="license"
					href="http://creativecommons.org/licenses/GPL/2.0/legalcode.pt" style="color:#FF6F61;" target="_blank">Creative

                ...
                <div id="menuTpl" class="hidden">
                    <ul class="nav navbar-nav">
                        ...
                        <li <?php if(isset($i3geoPermiteLogin) && $i3geoPermiteLogin == false) { echo "style=display:none "; }?>><a role="button"
                                onclick="i3GEO.login.recarrega = true; i3GEO.login.dialogo.abreLogin('../','template_mst_bt.html');" href="#topo" data-toggle="modal" data-target="#modalLogin">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer text-right" style="padding: 0px; padding-right: 15px; border: 0px; background-color: rgb(250, 250, 250);">
                            <div class="row center-block">
                                ...
                                <div class="col-xs-6">
                                    <a class="btn btn-primary" style="color: #008579;" href="{{{href}}}" role="button" target="{{{target}}}"> {{{abrir}}} </a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div tabindex="-1" class="container-fluid" style="background-color: #fff; margin-top: 10px; padding-top: 10px;">
        <div class="row text-center hidden">
            <div class="col-lg-12 center-block">
                ...
                <a tabindex="-1" rel="license" href="http://creativecommons.org/licenses/GPL/2.0/legalcode.pt" style="color: #008579;" target="_blank">Creative Commons - Licen&ccedil;a P&uacute;blica

		...
		<div class="col-md-12">
			...
			<div class="well hidden">
				...
				<h3 class="panel-heading">
					<a class="in" role="button" data-toggle="collapse" href="#raiz" aria-expanded="false"
						aria-controls="#raiz">{{{temasRaizMenu}}}</a>
				</h3>
				<div class="clearfix"></div>
				<div id="raiz" class="panel-body panel-collapse in"></div>
		...
		<form style="" onchange="this.style.boxShadow='2px 2px 5px 0 #009688';" class="form-horizontal" role="form" method="post" action="" >
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group form-group-lg">
						<label class="col-md-4 control-label" for="perfil">{{{ordem}}}</label>
						<div class="col-md-8">
		...
		<form style="" onchange="this.style.boxShadow='2px 2px 5px 0 #009688';" class="form-horizontal" role="form" method="post" action="" >
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group form-group-lg">
						<label class="col-md-4 control-label" for="perfil">{{{ordemTxt}}}</label>
						<div class="col-md-8">
							<input type="text" value="{{{ordem}}}" class="form-control" name="ordem">
						</div>
					</div>
...
<script>
	$(document).ready(function(){
		...
		i3GEOadmin.grupos.dicionario.ordemTxt = i3GEOadmin.core.dicionario.ordemTxt;

...
i3GEOadmin.arvore.dicionario = {
	'arvoreTemas' : [ {
		pt : "Administra&ccedil;&atilde;o do i3geo - &Aacute;rvore de temas ",
		en : "",
		es : ""
	} ],
    'ajuda' : [ {
    ...
    'txtCria' : [ {
		pt : "<p class=paragrafo>Utilize os bot&otilde;es para criar novos nomes de menus, grupos ou subgrupos, formando listas de itens.<br>Os itens criados podem ser reaproveitados em v&aacute;rios n&oacute;s da &aacute;rvore.</p>",
		en : "",
		es : ""
	} ],
    'editaGrupos' : [ {

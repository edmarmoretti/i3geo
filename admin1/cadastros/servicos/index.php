		...
		<div class="col-md-12">
			<div class="well hidden" id="titulo">
				...
				<div class="row pull-right">
					<a onclick="i3GEOadmin.webservices.adicionaWebserviceDialogo();" href="javascript:void(0)" class="btn btn-primary" role="button">{{{adicionar}}}</a>
				</div>
...
<script id="templateWebservices" type="x-tmpl-mustache">

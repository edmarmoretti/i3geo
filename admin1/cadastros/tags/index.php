...
<div class="container-fluid migalha">
	<div class="row">
		<div class="btn-group btn-breadcrumb">
			...
			<a class="btn btn-default" style="pointer-events: none"><span>Tags</span></a>
		</div>
	</div>
</div>
			...
			<div class="well hidden">
				<div class="panel-heading">
					<p class="lead" style="margin:0px;">&nbsp;
						<a title="{{{adicionar}}}" onclick="i3GEOadmin.tags.adicionaDialogo();" href="javascript:void(0)"
...
<script>
	$(document).ready(function(){
		...
		i3GEO.login.verificaOperacao("admin/html/tags",i3GEO.configura.locaplic, inicia, "sessao" ,i3GEOadmin.core.erroLogin);
	});
</script>
</body>
</html>

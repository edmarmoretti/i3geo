...
i3GEOF.graficoTema = {
	...
	*/
	html:function(){
		...
		ins += '			</div>';
		ins += '			<p>Escolha os itens to tipo num&eacute;rico que compor&atilde;o cada parte do gr&aacute;fico<br><br>';	
		...
		ins += '			<br><br>';
		ins += '			<input id=i3GEOgraficotemabotao1 size=35  type=button value="Criar gráficos" />';
		ins += '		<div id=i3GEOgraficotemamen1 style=top:10px;left:1px >Marque os itens para compor as partes do gr&aacute;fico: Edite os valores de cor (R,G,B) conforme o desejado. Ap&oacute;s escolher os itens, clique em criar gr&aacute;ficos para inserir um novo tema com os gr&aacute;ficos.</div>';
		ins += '	</div>';

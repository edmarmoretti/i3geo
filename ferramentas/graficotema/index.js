...
i3GEOF.graficoTema = {
	...
	*/
	iniciaJanelaFlutuante: function(){
		...
		titulo = "<span class='i3GEOiconeFerramenta i3GEOiconeGrTema'></span>" + "<div  id='i3GEOFgraficotemaComboCabeca' class='comboTemasCabecalho'>   ------</div><div class='i3GeoTituloJanela' style='margin-left:90px;'>"+$trad("t37a")+"</span><a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=8&idajuda=40' >&nbsp;&nbsp;&nbsp;</a></div>";

...
function t0()
{
	var ins = "<p>Ponto em pol&iacute;gono &eacute; uma opera&ccedil;&atilde;o que resulta em um novo tema contendo o cruzamento entre um tema com pontos e outro com pol&iacute;gono, que ficar&aacute; indicado na tabela do novo tema gerado."
...
function t3()
{
	...
	if ($i("temasPol"))
	{
		if ($i("temasPol").value != "")
		{
			ins = "O tema resultante ser&aacute; adicionado ao mapa atual.<br>"

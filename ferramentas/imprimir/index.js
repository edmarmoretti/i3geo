...
i3GEOF.imprimir = {
	...
	*/
	iniciaJanelaFlutuante: function(){
		...
		titulo = "<span class='i3GEOconeFerramenta i3GEOiconeImprimir'></span>" + $trad("d12") + " <a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=5&idajuda=49' >&nbsp;&nbsp;&nbsp;</a>";

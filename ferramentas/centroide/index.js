...
{
	aguarde("none")
	ins = "<p><img src='../../imagens/element-cell.gif'> Os centr&oacute;ides s&atilde;o pontos localizados no centro de massa de uma forma."
...
function criarcentroide()
{
	...
	cp.call(p,"criaCentroide",window.parent.ajaxredesenha);
}

...
function t0()
{
	ins = "<p><img src='../../imagens/module-d.grid.gif' > A grade &eacute; formada por pol&iacute;gonos espa&ccedil;ados conforme os par&acirc;metros de dx e dy."
...
function criargrade()
{
	...
	cp.call(p,"gradeDePol",window.parent.ajaxredesenha);
}

...
comboTemasSel("temasComSel",function(retorno){comboTemas = retorno})
t0()

function t0()
{
	aguarde("none")
	ins = "<p><img src='../../imagens/element-cell.gif'> O entorno, ou buffer, &eacute; um pol&iacute;gono que circunda um elemento geogr&aacute;fico em uma dist&acirc;ncia fixa."
...
function criarbuffer()
{
	...
	if (distancia*1 > 0)
	{
		...
		cp.call(p,"criaBuffer",window.parent.ajaxredesenha);
	}
}

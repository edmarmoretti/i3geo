...
i3GEOF.geolocal = {
	...
	Cria a janela flutuante para controle da ferramenta.
		...
		iniciaJanelaFlutuante: function(){
			...
			titulo = "<span class='i3GEOiconeFerramenta i3GEOiconeGeoLocal'></span>" + $trad('localizaUsuario',i3GEOF.geolocal.dicionario)+" <a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=6&idajuda=118' >&nbsp;&nbsp;&nbsp;</a>";

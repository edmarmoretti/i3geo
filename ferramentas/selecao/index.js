...
i3GEOF.selecao =
{
	...
	tiposel : function(obj) {
		...
		if(i3GEO.Interface["ATUAL"] == "openlayers"){
		    i3GEOF.selecao.tipoSel = obj.value;
		    i3GEOF.selecao.figura.openlayers.inicia();
	...
	box : {
		...
		inicia : function() {
		    i3GEO.eventos.cliquePerm.desativa();
		    i3GEOF.selecao.box.openlayers.removeControle();
		    i3GEOF.selecao.box.openlayers.draw = new ol.interaction.Draw({
			type : "Circle",
			freehand: true,
			geometryFunction: ol.interaction.Draw.createRegularPolygon(4)
		    });
		    i3GEOF.selecao.box.openlayers.draw.setActive(true);
		    i3GEOF.selecao.box.openlayers.draw.on("drawend",function(evt){
		    ...
		    i3geoOL.addInteraction(i3GEOF.selecao.box.openlayers.draw);
		},
		removeControle : function() {
		    i3geoOL.removeInteraction(i3GEOF.selecao.box.openlayers.draw);
		    i3GEOF.selecao.box.openlayers.draw = "";
		}
	    },
	...
	clique : {
		...
		inicia : function() {
		    i3GEO.eventos.cliquePerm.desativa();
		    i3GEOF.selecao.clique.openlayers.removeControle();
		    i3GEOF.selecao.clique.openlayers.draw = new ol.interaction.Draw({
			// features : i3GEO.desenho.layergrafico.getFeatures(),
			type : "Point",
			maxPoints : 1
		    });
		    i3GEOF.selecao.clique.openlayers.draw.on("drawend",function(evt){
			if (typeof (console) !== 'undefined')
			    console.info("i3GEOF.selecao.clique.openlayers.draw.on('drawend'");
		    ...
		    i3geoOL.addInteraction(i3GEOF.selecao.clique.openlayers.draw);
		},
		removeControle : function() {
		    i3geoOL.removeInteraction(i3GEOF.selecao.clique.openlayers.draw);
		    i3GEOF.selecao.clique.openlayers.draw = "";
		}
	    },
	    googlemaps : {
		inicia : function() {
	...
	figura : {
		...
		inicia : function() {
		    ...
		    i3GEO.eventos.cliquePerm.desativa();
		    i3GEOF.selecao.figura.openlayers.removeControle();
		    i3GEOF.selecao.figura.openlayers.draw = new ol.interaction.Select();
		    i3GEOF.selecao.figura.openlayers.draw.on("select",function(evt){
			var wkt, i, n, f, format = new ol.format.WKT();
			geo = i3GEOF.selecao.figura.openlayers.draw.getFeatures();
		    ...
		    i3geoOL.addInteraction(i3GEOF.selecao.figura.openlayers.draw);
		},
		removeControle : function() {
		    i3geoOL.removeInteraction(i3GEOF.selecao.figura.openlayers.draw);
		    i3GEOF.selecao.figura.openlayers.draw = "";
		}
	    },

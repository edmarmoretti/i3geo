...
comboCamadas("selCamada",tema,function(retorno)
	{
	 	...
	 	{$i("combot").innerHTML = "";montaComboItens()}
	 	else
	 	{
			$i("combot").innerHTML = "<div class=alerta >O tema escolhido &eacute; composto por mais de uma camada de dados. Selecione uma das camadas para filtrar:</div><br>"+retorno.dados
...
{mostraGuia("guia3");aplicaFiltro("sim")}
...
function adicionalinha()
{
	...
	interrogacao.onclick = function()
	{
		...
		(
			...
			{
	 			aguarde("none");
				$i("valores").innerHTML = "<br>Escolha o valor:"+retorno.dados;
				if ($i("cbitens"))
				{

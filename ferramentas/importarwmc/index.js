...
i3GEOF.importarwmc = {
	...
	*/
	html:function(){
		...
		'<p class="paragrafo" >Arquivo: <br><input class=digitar type="file" size=35 name="i3GEOimportarwmc" style="top:0px;left:0px;cursor:pointer;"></p>' +
		'<p class="paragrafo" >Ou URL: <br><input class=digitar type="text" size=35 name="i3GEOimportarwmcurl" style="top:0px;left:0px;cursor:text;"></p>' +
	...
	*/
	iniciaJanelaFlutuante: function(){
		...
		titulo = "Upload de WMC <a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=4&idajuda=27' >&nbsp;&nbsp;&nbsp;</a>";

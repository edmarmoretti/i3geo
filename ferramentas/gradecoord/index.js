...
i3GEOF.gradeCoord = {
	...
	*/
	html:function(){
		...
		'<tr><td>'+$trad(1,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		$inputText("","","i3GEOgradeCoordintervalo","",4,"2") +
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr><td>'+$trad(2,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		...
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr><td>'+$trad(3,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		$inputText("","","i3GEOgradeCoordlarguralinha","",11,"1") +
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr><td>'+$trad(4,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		'	<select id=i3GEOgradeCoordtipolinha >' +
		'		<option value="linha" >'+$trad(5,i3GEOF.gradeCoord.dicionario)+'</option>' +
		'		<option value="ferrovia-line2" >'+$trad(6,i3GEOF.gradeCoord.dicionario)+'</option>' +
		'	</select>' +
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		...
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr><td>'+$trad(7,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		$inputText("","","i3GEOgradeCoordtamanhotexto","",3,"10") +
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr><td>'+$trad(8,i3GEOF.gradeCoord.dicionario)+':</td>' +
		'	<td id=i3GEOgradeCoordfontef ></td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr>' +
		'	<td>'+$trad(9,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		...
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr><td>'+$trad(10,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		...
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr>' +
		'	<td>'+$trad(11,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		'		x '+$inputText("","","i3GEOgradeCoordshadowsizex","",3,"0") +
		'		<br>y '+$inputText("","","i3GEOgradeCoordshadowsizey","",3,"0") +
		'</td></tr>' +
		'<tr><td>&nbsp;</td><td></td></tr>' +
		'<tr><td>'+$trad(12,i3GEOF.gradeCoord.dicionario)+':</td><td>' +
		...
		'</td></tr>' +
		'</table><br>' +
		'<p class=paragrafo ><input id=i3GEOgradeCoordbotao1 size=10  type=button value="'+$trad(13,i3GEOF.gradeCoord.dicionario)+'" />';
		return ins;
	},
	/*
	...
	*/
	executa: function(){
		...
		{i3GEO.janela.tempoMsg($trad(14,i3GEOF.gradeCoord.dicionario));}
		else
		{

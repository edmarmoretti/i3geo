...
i3GEOF.uploadgpx = {
	...
	*/
	html:function(){
		...
		'<div id=i3GEOuploadgpxListaepsg width="98%" style="border:1px solid gray;left:0px;overflow:auto;height:60px"></div>' +
		...
		'</form>' +
		'<br><iframe name=i3GEOuploadgpxiframe style="text-align:left;" width="98%" height="60px"></iframe>';
		return ins;
	},
	/*

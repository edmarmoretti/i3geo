...
{
	aguarde("none")
	ins = "<p><img src='../../imagens/ptpol.gif'> Ponto em pol&iacute;gono &eacute; uma opera&ccedil;&atilde;o que resulta em um novo tema contendo o cruzamento entre um tema com pontos e outros com pol&iacute;gonos."
	...
	if ($i("temasPt"))
	{
		...
		else
		{
			checkTemasPolRaster(function(retorno)
			{
				...
				ins += "<br><br><div id=temasPoRaster style=width:90%;height:100px;overflow:auto >"+retorno+"</div>"
				ins = mensagemOpcao("",ins)
...
function cruza()
{
	...
	else
	{
		...
		cp.call(p,"pontoEmPoligono",retornacruza);
	}
}
function retornacruza(retorno)
{
	if (retorno.data != undefined)
	{
		retorno = retorno.data
		aguarde("none")
		$i("resultado").innerHTML = "<p> Os itens adicionados no novo tema foram renomeados conforme mostrado abaixo:</p>"+retorno

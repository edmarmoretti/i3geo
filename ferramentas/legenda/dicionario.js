...
i3GEOF.legenda.dicionario =
	{
		...
		"clusterAjuda" : [
  		...
  		"offsite" : [
   		...
   		"parLabels" : [ {
			pt : "Par&acirc;metros utilizados na inclus&atilde;o de textos nos elementos da camada",
			en : "",
			es : ""
		} ],
		'labels_msgAguarde': [ {
		...
		'labels_superiorEsquerdo': [ {
			pt : "superior esquerdo",
			en : "upper left",
			es : "superior izquierdo"
		} ],
		'labels_superiorCentro': [ {
			pt : "superior centro",
			en : "upper center",
			es : "superior centro"
		} ],
		'labels_superiorDireito': [ {
			pt : "superior direito",
			en : "upper right",
			es : "superior derecho"
		} ],
		'labels_centroEsquerdo': [ {
			pt : "centro esquerdo",
			en : "center left",
			es : "centro izquierdo"
		} ],
		...
		'labels_centroDireito': [ {
			pt : "centro direito",
			en : "right center",
			es : "centro derecho"
		} ],
		'labels_inferiorEsquerdo': [ {
			pt : "inferior esquerdo",
			en : "lower left",
			es : "inferior izquierdo"
		} ],
		'labels_inferiorCentro': [ {
			pt : "inferior centro",
			en : "lower center",
			es : "inferior centro"
		} ],
		'labels_inferiorDireito': [ {
			pt : "inferior direito",
			en : "lower right",
			es : "inferior derecho"
		} ],

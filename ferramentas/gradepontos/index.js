...
function t0()
{
	ins = "<p><img src='../../imagens/gradept.gif' > A grade &eacute; formada por pontos espa&ccedil;ados conforme os par&acirc;metros de x e y."
...
function criargrade()
{
	...
	cp.call(p,"gradeDePontos",window.parent.ajaxredesenha);
}
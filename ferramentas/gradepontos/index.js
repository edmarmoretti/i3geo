...
function t3()
{
	...
	ins += "<p>em X: "
	ins += "<input onclick='javascript:this.select();' class=digitar id='nptx' title='pontos em x'  type=text size=3 value='10'/>"
	ins += "<p>em Y: "
	ins += "<input onclick='javascript:this.select();' class=digitar id='npty' title='pontos em y'  type=text size=3 value='10'/>"

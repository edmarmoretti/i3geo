...
i3GEOF.vinde = {
	...
	*/
	iniciaJanelaFlutuante: function(){
		...
		titulo = "</div><a class='i3GeoTituloJanelaBs' target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=7&idajuda=114' >" + $trad('indeBrasil',i3GEOF.vinde.dicionario) + "</a>";

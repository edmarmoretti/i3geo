...
i3GEOF.vinde = {
	...
	*/
	iniciaJanelaFlutuante: function(){
		...
		titulo = "<span class='i3GEOiconeFerramenta i3GEOiconeVinde'></span>"
			+ "<div class='i3GeoTituloJanela'>" + $trad('indeBrasil',i3GEOF.vinde.dicionario) + "<a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=7&idajuda=114' ><b> </b></a></div>";

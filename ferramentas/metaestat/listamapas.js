...
i3GEOF.listamapas = {
	...
	iniciaJanelaFlutuante: function(){
		...
		titulo = "<span class='i3GEOconeFerramenta i3GEOiconeAplicStat'></span>" + "Mapas"+" <a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=9&idajuda=125' >&nbsp;&nbsp;&nbsp;</a>";

...
i3GEOF.upload = {
	...
	*/
	html:function(){
		...
		'<div id=i3GEOuploadListaepsg style="left:0px;overflow:auto;height:60px"></div>' +
		'<br><p class="paragrafo" ><input id=i3GEOuploadbotao1 type="button" value="Enviar arquivos" size=12 name="submit">' +
	...
	*/	
	criaJanelaFlutuante: function(){
		...
		cabecalho = function(){};
		minimiza = function(){
			var temp = $i("i3GEOF.upload_corpo");
			if(temp){

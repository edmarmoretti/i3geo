...
i3GEOF.graficointerativo1 = {
	...
	inicia : function(iddiv) {
		...
		$i("i3GEOgraficointerativo1guia2").onclick = function() {
			i3GEO.guias.mostraGuiaFerramenta("i3GEOgraficointerativo1guia2",
					"i3GEOgraficointerativo1guia");
		...
		$i("i3GEOgraficointerativo1guia4").onclick = function() {
			i3GEO.guias.mostraGuiaFerramenta("i3GEOgraficointerativo1guia4",
					"i3GEOgraficointerativo1guia");
		...
		$i("i3GEOgraficointerativo1guia5").onclick = function() {
			i3GEO.guias.mostraGuiaFerramenta("i3GEOgraficointerativo1guia5",
					"i3GEOgraficointerativo1guia");
			$i("i3GEOgraficointerativo1Grafico").style.display = "none";
		...
		if (i3GEOF.graficointerativo1.dados
			...
			// var retorno =
			// {"attributes":{"id":""},"data":{"dados":["n;x","'4';3839572","'8';81710320","'7';24631314","'2';10967753","'1';24496400","'3';18752482","'5';13574480","'6';216507515"]}};
			i3GEOF.graficointerativo1
	...
	iniciaJanelaFlutuante : function(dados) {
		...
		janela = i3GEO.janela.cria("380px", "310px", "", "", "", titulo,
							...
							if (retorno.tipo === "erro") {
								...
								$i("i3GEOgraficointerativo1ComboY").innerHTML = "<div>"
										...
										+ $trad(
												33,
												i3GEOF.graficointerativo1.dicionario)
										+ "' class=digitar type=text size=20 id=i3GEOgraficointerativo1ComboYidTitulo value='' /></div>";
								...
								$i("i3GEOgraficointerativo1ComboXid").onchange = function() {
									$i(this.id + "Titulo").value = this.options[this.selectedIndex].label;
								};
								var adicionaFilho = function() {
									var no = document.createElement("div"), tit = $i(this.id
											+ "Titulo"), novoselect;
									if (tit) {
										tit.value = this.options[this.selectedIndex].label;
									}
									no.innerHTML = retorno.dados + "<br>";
	...
	montaTabelaDados : function(retorno) {
		...
		//pega os nomes das clunas
		colunas = i3GEOF.graficointerativo1.nomesColunas();

	...
	<div class="container-fluid">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><?php echo $nome_grupo ; ?></li>
			</ol>
		</div>
	</div>
	<div class="container">
...
<script>
	$(document).ready(function(){
		ogc.grupo.id_menu = "<?php echo $id_menu ?>";
		ogc.grupo.nome_menu = "<?php echo $nome_menu ?>";
		ogc.grupo.id_grupo = "<?php echo $id_grupo ?>";
		ogc.grupo.nome_grupo = "<?php echo $nome_grupo ?>";

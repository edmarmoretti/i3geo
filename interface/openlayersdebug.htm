...
<script>
/*
Interface Openlayers para debug

Abre o i3geo com todas as suas funcionalidades e interface de navega&ccedil;&atilde;o controlada pela API Openlayers.

File: i3geo/interface/openlayers.htm

Exemplo:

http://<host>/i3geo/ms_criamapa.php

http://<host>/i3geo/interface/openlayers.htm
...
i3GEO.Interface.openlayers.parametrosMap.numzoom = 18;
*/
//
...
//ajusta a posi&ccedil;&atilde;o da barra de bot&otilde;es no IE
//if(navm)
//{i3GEO.barraDeBotoes.OFFSET = -45;}
//n&uacute;mero m&aacute;ximo de bot&otilde;es na barra de bot&otilde;es inicial
//i3GEO.barraDeBotoes.MAXBOTOES = 10;
...
//
//barra de botoes normal. descomente para usar
/*

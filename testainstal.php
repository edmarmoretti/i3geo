...
echo "As seguintes letras devem aparecer corretamente acentuadas: çÇãâáÁóÓ";
...
if (!extension_loaded("json")){echo "<span style=color:red >Problema: n&atilde;o est&aacute; instalado a json<br></span>";}

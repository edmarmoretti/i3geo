...
/*
$Id: nusoap.php,v 1.1.1.1 2006/06/08 17:13:18 06292871800 Exp $
...
* @version  $Id: nusoap.php,v 1.1.1.1 2006/06/08 17:13:18 06292871800 Exp $
* @access   public
*/
class nusoap_base {
    /**
...
* $soapclient = new Xsoapclient( string path [ ,boolean wsdl] );
*
...
* @access   public
*/
class Xsoapclient extends nusoap_base  {
    ...
    */
    ...
    ";
        ...
        $evalStr = 'class soap_proxy_'.$r.' extends Xsoapclient {
    '.$evalStr.'
}';
        return $evalStr;
    }

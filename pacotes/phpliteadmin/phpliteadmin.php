...
if($conexaoadmin == ""){
	...
	//$arquivosqlite = $locaplic."/sfb/admin.db";
	$directory = dirname($arquivosqlite);
	$databases = array
	(
		array
		(
...
if(!$auth->isAuthorized()) //user is not authorized - display the login screen
{
	...
	echo "N&atilde;o sabe a senha? Veja no arquivo i3geo/pacotes/phpliteadmin/senha.php<br><br>";
	echo "Al&eacute;m de saber a senha, voc&ecirc; precisa ser um administrador cadastrado em i3geo/ms_configura.php<br><br>";

  ...
  <div class="editor"> \
    <form class="form-stacked"> \
      <div class="clearfix"> \
        ...
        <div class="form-group"> \
          <label>Coluna do grupo (Axis 1)</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-add">Adiciona séries</button> \
      </div> \
...
my.GridRow = Backbone.View.extend({
  ...
  template: ' \
      ...
      <td data-field="{{field}}" style="width: {{width}}px; max-width: {{width}}px; min-width: {{width}}px;"> \
        <div class="data-table-cell-content"> \
          <a href="javascript:{}" class="data-table-cell-edit" title="Edite esta célula">&nbsp;</a> \
    ...
    <div class="menu-container data-table-cell-editor"> \
      ...
      <div id="data-table-cell-editor-actions"> \
        <div class="data-table-cell-editor-action"> \
          <button class="okButton btn primary">Atualiza</button> \
          <button class="cancelButton btn danger">Cancela</button> \
        </div> \
      </div> \
    </div> \
  ',
  ...
  onEditorOK: function(e) {
    ...
    this.trigger('recline:flash', {message: "Atualizando linhas...", loader: true});
    this.model.save().then(function(response) {
        this.trigger('recline:flash', {message: "Atualizado com sucesso", category: 'success'});
      })
      .fail(function() {
...
',
  ...
  latitudeFieldNames: ['lat','latitude','y','calcy'],
  longitudeFieldNames: ['lon','longitude','x','calcx'],
...
my.MapMenu = Backbone.View.extend({
  ...
  template: ' \
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="editor-field-type"> \
            <label class="radio"> \
              ...
              Latitude / Longitude campos</label> \
            <label class="radio"> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label>Coluna geometria (GeoJSON)</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-update-map">Atualiza</button> \
      </div> \
      <div class="editor-options" > \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-auto-zoom" value="autozoom" checked="checked" /> \
          Auto zoom para a feição</label> \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-cluster" value="cluster"/> \
          Agrupamento de pontos</label> \
      </div> \
...
my.GridControl= Backbone.View.extend({
  ...
  template: '<h1><button href="#" class="recline-row-add btn btn-default">Adiciona linha</button></h1>',
...
my.FilterEditor = Backbone.View.extend({
  ...
  template: ' \
    <div class="filters"> \
      <h3>Filtros</h3> \
      <a href="#" class="js-add-filter">Adiciona filtro</a> \
      <form class="form-stacked js-add" style="display: none;"> \
        ...
        <div class="form-group"> \
          ...
          <select class="filterType form-control"> \
            ...
            <option value="geo_distance">Distância geo</option> \
          </select> \
        </div> \
      ...
      <form class="form-stacked js-edit"> \
        ...
        {{/filters}} \
        {{#filters.length}} \
        <button type="submit" class="btn btn-default">Atualiza</button> \
        {{/filters.length}} \
      </form> \
    </div> \
  ',
      ...
      <div class="filter-{{type}} filter"> \
        <fieldset> \
          <legend> \
            ...
            <a class="js-remove-filter" href="#" title="Remove filtro" data-filter-id="{{id}}">&times;</a> \
          </legend> \
    ...
    geo_distance: ' \
      <div class="filter-{{type}} filter"> \
        <fieldset> \
          ...
          <div class="form-group"> \
            <label class="control-label" for="">Distância (km)</label> \
    ...
    <form action="" method="GET" class="form-inline" role="form"> \
      <div class="form-group"> \
        <div class="input-group text-query"> \
          ...
          <label for="q">Localizar</label> \
          <input class="form-control search-query" type="text" id="q" name="q" value="{{q}}" placeholder="Localizar ..."> \
        </div> \
      </div> \

...
i3GEO.arvoreDeTemas = {
	...
	comboMenus : function(locaplic, funcaoOnchange, idDestino, idCombo,
	    ...
	    i3GEO.arvoreDeTemas.listaDeMenus(combo);
	},
	listaDeMenus : function(after){
	    i3GEO.request.get({
		snackbar: false,
		snackbarmsg: false,
		btn: false,
	...
	comboGruposMenu : function(locaplic, funcaoOnchange, idDestino, idCombo,
	    ...
	    i3GEO.arvoreDeTemas.listaDeGrupos(combo, id_menu, "nao");
	},
	listaDeGrupos : function(after, id_menu, listasgrupos, ordenaNome, filtraOgc, filtraDown){
	    if(!ordenaNome){
		ordenaNome = "nao";
	    }
	    if(!filtraOgc){
	...
	listaDeSubGrupos: function(after, id_menu, id_grupo) {
	    var filtro = "";
...
comboSubGruposMenu : function(locaplic, funcaoOnchange, idDestino, idCombo,
	...
	i3GEO.arvoreDeTemas.listadeSubGrupos(combo, "", idGrupo);
    }
},
/**

i3GEO.catalogoMenus = {
	...
	getUploadBtn: function () {
		...
		//Marca em vermelho se a opção de upload estiver bloqueada no ms_configura.php
		if (i3GEO.parametros.i3geoBlFerramentas.lastIndexOf("upload") >= 0) {
			console.warn("Upload bloqueado no ms_configura.php");
			var c = "background-color: red;";
		} else {
			var c = "";
		}
		var btn = ""
			+ "<div style='" + c + "' class='uploadbtn container-fluid container-tools'>"
			+ "<div class='form-group condensed'>"
			+ t
			+ "</div>"
			+ "</div>";
		if (i3GEO.parametros.i3geoBlFerramentas.lastIndexOf("upload") >= 0 && window.location.hostname != "localhost") {
			return "";
		}
		return btn;
	},

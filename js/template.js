...
i3GEO.template = {
	...
	janela: {
		...
		msg: "<div class='modal ' data-keyboard='false' tabindex='-1' role='dialog' aria-hidden='true' style='z-index:500000;overflow-y:visible;'><div class='modal-dialog' ><div class='modal-content'><div class='modal-header' style='padding-top: 5px;'><button type='button' class='closeModal close pull-right' data-bs-dismiss='modal' aria-label='Close'><i class='material-icons'>highlight_off</i></button></div><div class='modal-body' style='padding-top: 0px;'><div id='i3GEOMensagemTempoModal' > {{{texto}}} </div></div></div></div></div>",
		closemsg: "<div class='modal ' data-keyboard='false' tabindex='-1' role='dialog' aria-hidden='true' style='z-index:500000;overflow-y:visible;'><div class='modal-dialog'><div class='modal-content'><div class='modal-header' style='padding-top: 5px;'><button type='button' class='closeModal close pull-right' data-bs-dismiss='modal' aria-label='Close'><i class='material-icons'>highlight_off</i></button></div><div class='modal-body' style='padding-top: 0px;'><div class='container-fluid' id='i3GEOMensagemCloseModal' > {{{texto}}} </div></div></div></div></div>",
		formModal: "<div data-bs-backdrop='false' id='formModal{{{id}}}' aria-hidden='true' class='modal-dialog' role='document' style='z-Index:60;'><div class='modal-content' style='height:100%;max-height: 100vh;'><div class='modal-header handleDraggable' style='padding-top: 5px;height:30px;'><span class='pull-left' id='i3GEOToolFormModalHeader{{{id}}}' style='text-align:left;'>{{{header}}}</span><button data-bs-dismiss='modal' type='button' class='closeModal close pull-right' aria-label='Close'><i class='material-icons'>highlight_off</i></button><button type='button' class='close expandModal pull-right' aria-label='Expand'><i class='material-icons'>fullscreen</i></button></div><div class='modal-body' style='height:calc(100% - 75px);padding-top: 0px;cursor:default;'><div id='i3GEOToolFormModalWrap{{{id}}}' style='display:none;width:100%;height:100%;position:absolute; top:0px;left:0px;background-color: transparent;z-index: 100;'></div><div id='i3GEOToolFormModal{{{id}}}' style='height:100%;'> {{{texto}}} </div></div><div id='i3GEOToolFormModalFooter{{{id}}}' style='height:75px;' class='modal-footer'></div></div></div>"
	},
	forms: {

...
i3GEO.template = {
	...
	janela : {
	    ...
	    formModal: "<div class='modal-dialog' role='document' style='z-Index:60;'><div class='modal-content' style='height:100%;max-height: 100vh;'><div class='modal-header handleDraggable' style='padding-top: 5px;height:30px;'><span class='pull-left' id='i3GEOToolFormModalHeader' style='text-align:left;'>{{{header}}}</span><button type='button' class='closeModal close pull-right' data-dismiss='modal' aria-label='Close'><i class='material-icons'>highlight_off</i></button><button type='button' class='close expandModal pull-right' aria-label='Expand'><i class='material-icons'>fullscreen</i></button></div><div class='modal-body' style='height:100%;padding-top: 0px;cursor:default;'><div id='i3GEOToolFormModalWrap' style='display:none;width:100%;height:100%;position:absolute; top:0px;left:0px;background-color: transparent;z-index: 100;'></div><div id='i3GEOToolFormModal' style='height:100%'> {{{texto}}} </div></div><div id='i3GEOToolFormModalFooter' class='modal-footer'></div></div></div>"
	},

...
i3GEO.pluginI3geo =
{
    ...
    heatmap: {
        ...
        inicia: function (camada, objMapa) {
            ...
            var p = i3GEO.configura.locaplic + "/ferramentas/heatmap/getdata.php", criaLayer;
            criaLayer = function () {
                if (typeof (console) !== 'undefined')
    ...
    markercluster: {
        ...
        inicia: function (camada, objMapa) {
            ...
            var nomeScript = "markercluster_script", p = i3GEO.configura.locaplic + "/ferramentas/markercluster/getdata.php", carregaJs =
                "nao", criaLayer;
            criaLayer = function () {
                if (typeof (console) !== 'undefined')
    ...
    layergeojson: {
        ...
        inicia: function (camada) {
            ...
            layergeojson.getSource().forEachFeature(function (feature, layer) {
                feature.setId(i3GEO.util.uid() + "_geojson");
            });
